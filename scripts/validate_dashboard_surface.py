...
for forbidden in ("radial-gradient", "linear-gradient", "Inter,ui-sans-serif", "Find edges.", "Tell AI"):
...
for required in (
    ...
    "/api/v1/research/sw1-manus", "Claude · reference specification",
    "Manus · independent specification", "Read-only", "Research ledger",
):
